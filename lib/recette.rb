class Recette
  attr_reader :title, :uri, :image, :url, :ingredients, :calories, :nutrients, :dailyneed, :source, :diet_labels, :health_labels, :allergies
  ...
  def initialize(hash)
    ...
    raise ArgumentError if hash["uri"] == nil || hash["uri"] == ""
